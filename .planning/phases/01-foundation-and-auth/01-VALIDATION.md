...
- [ ] `tests/test_health.py` — basic app startup test
- [ ] `pytest` + `httpx` + `anyio` — test dependencies installed

*Wave 0 stubs will be detailed during planning.*
...
| Docker compose up reaches wizard | SETUP-01 | Requires Docker runtime | Run `docker compose up`, open browser to localhost:8000 |
